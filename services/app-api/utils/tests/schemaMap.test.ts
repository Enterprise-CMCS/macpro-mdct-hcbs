import { AnyObject, MixedSchema } from "yup";
import {
  number,
  ratio,
  date,
...
describe("Schemas", () => {
  ...
  test("Test validNumber schema", () => {
    testValidNumber(validNumber() as any, goodValidNumberTestCases, true);
    testValidNumber(validNumber() as any, badValidNumberTestCases, false);
  });
});
