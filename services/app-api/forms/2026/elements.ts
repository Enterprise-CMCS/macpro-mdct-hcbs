...
export const measureInstructionsWithTechSpecs: AccordionTemplate = {
  ...
  value:
    ...
    '<a href="https://www.medicaid.gov/license/form/8586/3396" style=color: #0071bc; text-decoration: underline; :visited={color: #004f84} target="_blank">View Current Technical Specifications (opens in new tab)</a>',
};
