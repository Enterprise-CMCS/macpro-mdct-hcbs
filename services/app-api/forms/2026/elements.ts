...
export const sectionCompleteBanner: StatusAlertTemplate = {
  ...
  text: "You can still edit the this section but the the status will change to ‘In progress’ and you will need to re-select the ‘Complete section button. <a>Click here</a> or select ‘Return to measure details’ button above to return to the previous page.",
  status: "success",
};
