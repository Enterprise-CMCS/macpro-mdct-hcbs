      ...
      elements: [
        ...
        },
        {
          ...
          value:
            ...
            "<p><b>Understanding Measure Statuses </b>" +
            "<p><b>Not Started</b>:  No data has been entered or actions taken on the measure." +
            "<p><b>In Progress</b>:  The measure is actively being worked on, with some or all data entered." +
            "<p><b>In Progress</b>:  The measure is actively being worked on, with some or all data entered." +
            "<p><b>Complete</b>:  The measure has been completed." +
            "<p>Before submitting this form, all required measures must be in the <b>Complete</b> status.",
        },
        {
          type: ElementType.MeasureTable,
