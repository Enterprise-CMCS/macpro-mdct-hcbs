...
import { harReportTemplate as harReportTemplate2028 } from "./2028/ha/ha";
...
const formsByYear = {
  2026: {
    ...
    harReportTemplate: harReportTemplate2026,
  ...
  2028: {
    ...
    harReportTemplate: harReportTemplate2028,
...
export const getReportTemplate = (reportType: ReportType, year: number) => {
  ...
  switch (reportType) {
    ...
    case ReportType.HA:
      return formsByYear[year].harReportTemplate;
    case ReportType.CI:
